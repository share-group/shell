#linux mysql自动安装程序 
#运行例子：mkdir -p /shell && cd /shell && rm -rf install-mysql.sh && wget --no-cache https://raw.githubusercontent.com/ruanzhijun/share/master/shell/install-mysql.sh && sh install-mysql.sh /usr/local
