#linux mysql自动安装程序 
#运行例子：mkdir -p /shell && cd /shell && rm -rf install-mysql.sh && wget --no-cache https://raw.githubusercontent.com/share-group/shell/master/docker/install-mysql.sh && sh install-mysql.sh 5.7.17 /usr/local
