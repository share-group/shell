#linux nginx自动安装程序 
#运行例子：mkdir -p /shell && cd /shell && rm -rf install-nginx.sh && wget --no-cache https://raw.githubusercontent.com/ruanzhijun/share/master/shell/docker/install-nginx.sh && sh install-nginx.sh 1.10.3 /usr/local
