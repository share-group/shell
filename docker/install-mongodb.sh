#linux mongodb自动安装程序 
#运行例子：mkdir -p /shell && cd /shell && rm -rf install-mongodb.sh && wget --no-cache https://raw.githubusercontent.com/ruanzhijun/share/master/shell/docker/install-mongodb.sh && sh install-mongodb.sh 3.4.2 /usr/local
