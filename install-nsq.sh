#linux nsq
#运行例子：mkdir -p /shell && cd /shell && rm -rf install-nsq.sh && wget --no-cache https://raw.githubusercontent.com/share-group/shell/master/install-nsq.sh && sh install-nsq.sh
