#linux gradle
#运行例子：mkdir -p /shell && cd /shell && rm -rf install-java.sh && wget --no-cache https://raw.githubusercontent.com/ruanzhijun/share/master/shell/install-java.sh && sh install-java.sh /usr/local
