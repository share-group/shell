#linux java
#运行例子：mkdir -p /shell && cd /shell && rm -rf install-go.sh && wget --no-cache https://raw.staticdn.net/share-group/shell/master/install-go.sh && sh install-go.sh 1.21.0 /usr/local
